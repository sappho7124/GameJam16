...
switch (state_key) {
	...
	if (pal != noone) {
            ...
            instance_create_depth(x + -8, y - 17, -450, EmoteForHumans,talk_emote_attributes);
			instance_create_depth(pal.x + -8, pal.y - 17, -450, EmoteForHumans,talk_emote_attributes);
	}
	break;
